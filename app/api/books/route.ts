...
const BookSchema = z.object({
  ...
  asinPaperback: z.string().optional().nullable(),
  asinAudiobook: z.string().optional().nullable(),
  isbnPaperback: z.string().optional().nullable(),
  isbnHardcover: z.string().optional().nullable(),
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const createData = {
      ...
      asinPaperback: body.asinPaperback ? String(body.asinPaperback).trim() : null,
      asinAudiobook: body.asinAudiobook ? String(body.asinAudiobook).trim() : null,
      isbnPaperback: body.isbnPaperback ? String(body.isbnPaperback).trim() : null,
      isbnHardcover: body.isbnHardcover ? String(body.isbnHardcover).trim() : null,
