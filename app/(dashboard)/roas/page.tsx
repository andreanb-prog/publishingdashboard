...
export default function ROASPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        <h1 className="font-serif text-[22px] text-navy-DEFAULT mb-1">Daily ROAS Log</h1>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div key={s.label} className="card p-4">
            ...
            <div className="font-serif text-[26px] text-navy-DEFAULT tracking-tight">{s.value}</div>
      ...
      <div className="card p-6 mb-5">
        <div className="text-[14px] font-bold text-navy-DEFAULT mb-4">Log today's numbers</div>
      ...
      {logs.length > 0 && (
        <div className="card overflow-hidden">
          <div className="px-5 py-3.5 border-b border-stone-100 text-[13.5px] font-semibold text-navy-DEFAULT">
            Log history
          </div>
