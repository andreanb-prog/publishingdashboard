...
export function OverviewClient() {
  ...
  return (
    <div className="p-8 max-w-[1400px]">
      ...
      {/* Channel Cards */}
      <div className="mb-1">
        <h2 className="font-serif text-[18px] text-navy-DEFAULT mb-1">Your channels — click any for the full deep dive</h2>
        ...
        {CHANNEL_CARDS.map(card => {
          ...
          return (
            ...
            >
              ...
              <div className="font-serif text-[22px] text-navy-DEFAULT tracking-tight leading-none mb-1.5">
                {score?.metric || '—'}
              </div>
      ...
      <div className="flex items-baseline justify-between mb-4">
        <h2 className="font-serif text-[18px] text-navy-DEFAULT">
      ...
      {loading ? (
        ...
        <div className="card p-8 text-center">
          ...
          <div className="font-serif text-lg text-navy-DEFAULT mb-2">Upload your files to get your coaching session</div>
