...
export default function LearnPage() {
  ...
  return (
    <div className="p-8 max-w-3xl">
      {/* Header */}
      <div className="card p-6 mb-6" style={{ background: '#0d1f35', border: 'none' }}>
        <h1 className="font-serif text-[22px] text-white mb-2">Every term explained like a friend</h1>
          ...
          >
            ...
            >
              ...
              <div className="flex-1">
                <div className="text-[14.5px] font-bold text-navy-DEFAULT">{term.term}</div>
