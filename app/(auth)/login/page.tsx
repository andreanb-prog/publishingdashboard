    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex md:w-1/2 flex-col justify-center px-16"
        ...
        <div className="max-w-md">
          <div style={{ fontFamily: 'var(--font-serif)', fontSize: 28, fontWeight: 600, color: 'var(--ink)', marginBottom: 16 }}>
            AuthorDash
          </div>
          <p className="text-[17px] leading-relaxed mb-6" style={{ color: '#374151' }}>
            One number. One clear action. No spreadsheets. No guessing.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6"
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="md:hidden text-center mb-8">
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 28, fontWeight: 600, color: 'var(--ink)' }}>
              AuthorDash
            </div>
