    ...
    <div className="min-h-screen bg-[#0d1f35] px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8" style={{ color: 'rgba(255,255,255,0.7)' }}>
          ...
          <section>
            <h2 className="font-serif text-[20px] text-white mb-3">This is a beta product</h2>
          ...
          <section>
            <h2 className="font-serif text-[20px] text-white mb-3">No guarantees of results</h2>
            <p className="text-[14px] leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-[20px] text-white mb-3">You own your data</h2>
            <p className="text-[14px] leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-[20px] text-white mb-3">Pricing</h2>
            <p className="text-[14px] leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-[20px] text-white mb-3">Cancel anytime</h2>
            <p className="text-[14px] leading-relaxed">
          ...
          <section>
            <h2 className="font-serif text-[20px] text-white mb-3">Acceptable use</h2>
            <p className="text-[14px] leading-relaxed">
        ...
        <div className="mt-14 pt-8 flex gap-6 text-[12px]"
          ...
          <Link href="/privacy" className="no-underline hover:underline" style={{ color: 'rgba(255,255,255,0.35)' }}>
            Privacy Policy
          </Link>
        </div>
