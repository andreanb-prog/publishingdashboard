...
export function DashboardBanners({ dashboard }: { dashboard: DashboardState }) {
  ...
  return (
    <>
      {metaErrorBanner && (
        <div className="mb-4 px-5 py-3.5 flex items-center gap-3" style={{ background: 'rgba(217,119,6,0.06)', borderLeft: '3px solid #D97706', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
